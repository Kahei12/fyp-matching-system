 ...
 * 8 teachers: Bell(5), Alex(4), Farah(3), Adam(3), Hugh(4), Steven(4), Tabitha(4), Yaru(3) = 30
 */
/** Display names = Teacher account name (nickname + surname); IDs align with seed TEACHERS t001–t008 */
const TEACHER_BY_PROJECT_ID = {
  ...
  18: { supervisor: 'Prof. Steven Chen', supervisorId: 'T006', supervisorEmail: 't006@hkmu.edu.hk' },
  ...
  22: { supervisor: 'Prof. Steven Chen', supervisorId: 'T006', supervisorEmail: 't006@hkmu.edu.hk' },
  23: { supervisor: 'Prof. Steven Chen', supervisorId: 'T006', supervisorEmail: 't006@hkmu.edu.hk' },
